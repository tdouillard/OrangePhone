...
class RecyclerViewAddGroup extends RecyclerView.Adapter<RecyclerViewCursorViewHolder> {
    ...
    public RecyclerViewAddGroup(Context context, Cursor c) {
...
//                    Picasso.with(context).load(contactUri).transform(new RoundedCornersTransformation(10, 10)).into(myViewHolder.quickContact);
    ...
    public boolean isToggled(int pos){
    ...
    @Override
    public void onBindViewHolder(final RecyclerViewCursorViewHolder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               toggleSelection(position);
                holder.background.setSelected(!isToggled(position));
            }
        });
